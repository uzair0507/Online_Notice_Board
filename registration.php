	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<Td><input type="email"  placeholder="example@xyz.com"  class="form-control"  maxlength="25" name="e"></td>
				</tr>
				
				<tr>
					<td>Enter Your Password </td>
					<Td><input id="password" placeholder="********" class="form-control" type="password" maxlength="25" name="p"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" onkeypress="capLock(event)"></td>
				</tr>
				
				<tr>
					<td>Enter Your Mobile </td>
					<Td><input type="text"class="form-control" name="mob" pattern="[7-9]{1}[0-9]{9}" 
